...
tag: 'writing'
canonicalUrl: 'https://aidankiser.com/blog/blogging-tips-after-3-years/'
---
...
I usually write almost all of my blog posts in Markdown format and store each draft on my laptop, inside a directory of [my blog site](https://aidankiser.com). This way, it saves me time when I publish them since I use Gatsby and Markdown format for each blog post.
