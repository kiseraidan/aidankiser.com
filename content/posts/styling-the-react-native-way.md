...
tag: 'expo'
canonicalUrl: 'https://aidankiser.com/blog/styling-the-react-native-way/'
---
...
In the post [**Getting Started with React Native in 2019**](https://aidankiser.com/getting-started-with-react-native-in-2019-build-your-first-app/), I've described about `StyleSheet` object. It is the second way.
