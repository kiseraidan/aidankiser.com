...
You can also check the [complete source code for this example is at this GitHub repo](https://github.com/kiseraidan/react-native-examples/tree/main/infinite-scroll-with-react-query).
