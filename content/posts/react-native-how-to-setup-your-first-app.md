...
Getting Started with React Native in 2019: Build Your First App Learn how to build your first React Native app with important basic concepts and where to go from [here](https://aidankiser.com/blog/getting-started-with-react-native-in-2019-build-your-first-app).
...
Link to the [**Github Repo**](https://github.com/kiseraidan/rn-HelloWorld) for this project if you are still curious too see the how the project structure looks rather than trying it out yourself.
