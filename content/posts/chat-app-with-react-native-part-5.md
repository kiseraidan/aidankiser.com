...
In the [next part](https://aidankiser.com/blog/chat-app-with-react-native-part-6) of the series we are going to fix a small bug related of status bar styles for every screen component in the current app. This is going to be done by creating a custom hook and using `react-navigation`.

😺 **You can find the complete code here at this [GitHub repo](https://github.com/kiseraidan/react-native-examples/tree/master/ChatApp).**
