...
tag: 'react-native'
canonicalUrl: 'https://aidankiser.com/blog/how-to-add-a-splash-screen-and-app-icon-in-react-native-with-react-native-bootsplash'
---
...
[**Complete source code for this example is at this GitHub repo**](https://github.com/kiseraidan/react-native-examples/tree/master/rnSplashAndIconExample)
