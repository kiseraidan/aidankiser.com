...
> **UPDATE:** Up to date version of this post is at [How to use ES6 import syntax in Node.js](https://aidankiser.com/blog/how-to-use-es6-import-syntax-in-node/).
...
_You can find the complete source code for the above article at_ [**_Github Repo_**](https://github.com/kiseraidan/node-babel-setup)
